...
import me.plugin.teleportcommands.commands.HomeList;
...
public final class TeleportCommands extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        new HomeTP(plugin);
        try {
            CommandManager.createCoreCommand(this, "home", "Creates homes to teleport to", "/home", null, HomeSet.class, HomeDelete.class, HomeTP.class, HomeList.class);
